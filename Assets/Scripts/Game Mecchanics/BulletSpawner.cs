...
namespace BulletHell.Spawners
{
    public class BulletSpawner : MonoBehaviour
    {
        ...
        public void Start()
        {
            ObjectPooler.Instance.warmPool(m_BulletPrefab, 100);
        }
        ...
        public void CalculateBullet(int i, int j, float arrayAngle, float bulletAngle)
        {
            ...
            var bullet_component = bullet.GetComponent<BulletController>();
        ...
        {
            GameObject tmp = ObjectPooler.Instance.GetPooledProjectile();
